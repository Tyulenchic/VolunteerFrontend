...
const FAQS = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: 'Как связаться с поддержкой?', a: 'Используйте форму обратной связи на главной странице, напишите на email ump@minpros.gospmr.org или позвоните по телефону  0 (533) 2-22-29. (Пн-Пт, 8:00-17:00).' },
    ],
  },
];
