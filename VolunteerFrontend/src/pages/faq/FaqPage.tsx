...
const FAQS = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: 'Как связаться с поддержкой?', a: 'Используйте форму обратной связи на главной странице, напишите на email info@volunteerspmr.org или позвоните по телефону +373 777 12-345 (Пн-Пт, 9:00-18:00).' },
    ],
  },
];
