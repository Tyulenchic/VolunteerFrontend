...
const SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      'Участники несут личную ответственность за своё здоровье и безопасность. Администрация и организаторы не несут ответственности за несчастные случаи, произошедшие по вине самого участника.',
    ],
  },
  {
    id: 'content',
  ...
  },
  {
    ...
    items: [
      ...
      'Если вы считаете блокировку необоснованной, вы можете обратиться по адресу info@volunteerspmr.org с объяснением ситуации.',
    ],
  },
];
            ...
            <aside className="lg:w-56 flex-shrink-0">
              <div className="sticky top-24">
                ...
                <nav className="space-y-1">
                  {SECTIONS.map(s => (
                    <a key={s.id} href={`#${s.id}`} className="block text-sm text-gray-600 hover:text-primary transition no-underline py-1 px-2 rounded-lg hover:bg-gray-50">
                      {s.title}
                    </a>
                  ))}
                </nav>
